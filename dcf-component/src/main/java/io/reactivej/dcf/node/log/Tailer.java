...
public class Tailer implements Runnable {
        ...
        try {
            ...
            while (run && reader == null) {
                ...
                if (reader == null) {
                    ...
                    // mod by lhh
                    long backLength = file.length() - 10240 > 0 ? 10240 : file.length();
                    position = end ? file.length() - backLength : 0;
    ...
    private long readLines(RandomAccessFile reader) throws IOException {
        Utf8StringBuffer sb = new Utf8StringBuffer();
        ...
        while (run && ((num = reader.read(inbuf)) != -1)) {
            for (int i = 0; i < num; i++) {
                ...
                default:
                    ...
                    sb.append(ch); // add character, not its ascii value
                }
            }
